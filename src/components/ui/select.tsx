...
function SelectTrigger({
  ...
  return (
    <SelectPrimitive.Trigger
      ...
      data-size={size}
      className={cn(
        "group border-input bg-background hover:border-primary/45 hover:bg-accent/35 focus-visible:border-primary focus-visible:ring-primary/15 aria-invalid:border-destructive aria-invalid:ring-destructive/20 data-placeholder:text-muted-foreground dark:bg-input/30 dark:hover:bg-input/50 data-[popup-open]:border-primary data-[popup-open]:ring-primary/15 flex w-fit cursor-pointer items-center justify-between gap-3 rounded-xl border px-3.5 text-sm font-semibold whitespace-nowrap shadow-xs transition-[background-color,border-color,color,box-shadow] duration-200 ease-out outline-none select-none focus-visible:ring-3 disabled:cursor-not-allowed disabled:opacity-50 aria-invalid:ring-3 data-[popup-open]:ring-3 data-[size=default]:h-12 data-[size=sm]:h-10 data-[size=sm]:rounded-lg *:data-[slot=select-value]:line-clamp-1 *:data-[slot=select-value]:flex *:data-[slot=select-value]:items-center *:data-[slot=select-value]:gap-2 [&_svg]:pointer-events-none [&_svg]:shrink-0",
        className,
      )}
      {...props}
    >
